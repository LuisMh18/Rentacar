								...
								"sPaginationType": "bootstrap",
											...
											tabla_a.fnClearTable();
													...
													for(var i = 0; i < l.length; i++) {
																				tabla_a.fnAddData([
																															'<span class="text-info txt-escondido">Nombre: </span><span class="hidden">'+l[i].created_at+'</span>'+l[i].nombre_plaza,
		...
		$.ajax({
								...
								success: function(p){
										...
										nueva_fila = '<tr id="fila_'+p.id+'">'+
												'<td><span class="text-info txt-escondido">Nombre: </span><span class="hidden">'+p.created_at+'</span>'+p.nombre_plaza+'</td>'+
