								...
								"sPaginationType": "bootstrap",
											...
											tabla_a.fnClearTable();
													...
													for(var i = 0; i < l.length; i++) {
																				tabla_a.fnAddData([
																															'<span class="text-info txt-escondido">Cobertura: </span><span class="hidden">'+l[i].created_at+'</span>'+l[i].cobertura,
		...
		$.ajax({
								...
								success: function(p){
										...
										nueva_fila = '<tr id="fila_'+p.id+'">'+
												'<td><span class="text-info txt-escondido">Cobertura: </span><span class="hidden">'+p.created_at+'</span>'+p.cobertura+'</td>'+
